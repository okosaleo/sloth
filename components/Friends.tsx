...
export default function FriendComponent() {
  ...
  return (
    <div className="flex min-h-[40vh] flex-col items-center justify-center p-6 bg-primary-bg">
      ...
      <p className='font-Nohemi font-bold text-sm text-text-color'><span className='text-button-color'>Share</span> your invite link with your <span className='text-button-color'>friends</span> and get 200 sloth for each referral.<br /> <span className='text-[#28d828]'>400 points till New Years.</span></p>
    </div>
  )
}