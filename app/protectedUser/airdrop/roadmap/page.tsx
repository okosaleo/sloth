  ...
  return (
    <div className="container mx-auto p-8 font-Nohemi text-text-color overflow-y-scroll h-fit mb-20">
      ...
      <section className="mt-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Phase 2: Earning Event</h2>
        <ul className="list-disc pl-6 text-gray-700">
      ...
      <section className="mt-8">
        ...
        <ul className="list-disc pl-6 text-gray-700">
          <li>Host events with influencers</li>
          <li>Reach more global Telegram groups</li>
        </ul>
      </section>

      <section className="mt-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Phase 5: Conclusion & Future Plans.</h2>
        <ul className="list-disc pl-6 text-gray-700">
